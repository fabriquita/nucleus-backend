...
public class UserControllerTest {
    ...
    public void allTest() {
    	...
    	Map<String,Object> user = (Map<String, Object>) restTemplate.getForObject(baseUrl, Vector.class).firstElement();
    	User root = new User();
    	...
    	User rootUser = restTemplate.getForObject(baseUrl+root.getId(), User.class);
    	...
    	User updatedUser = restTemplate.postForObject(baseUrl+root.getId(), updateData , User.class);
    	assertEquals(nameToUpdate,updatedUser.getName());

    	//Delete it
    	
    	restTemplate.delete(baseUrl+root.getId());
    	User deletedUser = restTemplate.getForObject(baseUrl+root.getId(), User.class);
