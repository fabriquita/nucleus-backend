...
public class UserPopDB {
    ...
    public void popDB() {
        ...
        User user1 = userService.add(firstName1, lastName1, userName1, userPassword1, group1.getId(), role1.getId(), email1);
        User user2 = userService.add(firstName2, lastName2, userName2, userPassword2, group2.getId(), role2.getId(), email2);
